...
def anime_bronze(context: AssetExecutionContext, duck: DuckDBResource):
...
@asset(compute_kind="python")
def character_bronze(context: AssetExecutionContext, duck: DuckDBResource):
...
@asset(compute_kind="python")
def staff_bronze(context: AssetExecutionContext, duck: DuckDBResource):
...
@asset(compute_kind="python")
def studio_bronze(context: AssetExecutionContext, duck: DuckDBResource):
