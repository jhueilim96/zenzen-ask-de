...
from ...resources import TypesenseSearchIndexResource
...
def create_entity_index(context:AssetExecutionContext, typesense_:TypesenseSearchIndexResource):
